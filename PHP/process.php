...
mysql_select_db("onetoone_requests")or die("<p><span style=\"color: red;\">Unable to select database</span></p>");
...
$result=MYSQL_QUERY("INSERT INTO requests (name,email,phone,notes)
                    VALUES ('$name', '$email', '$phone', '$notes')")or die (mysql_error());
mysql_close();
//confirm
echo "
        <html>
	...
	<link rel=\"icon\" href=\"http://onetoonehelp.com/images/favicon.png\">	
		...
		<img id=\"home-image\" src=\"../images/OnetoOneHead.png\" width=\"150\" alt=\"Home Page\" height=\"150\"/>
                ...
                Thank You! Your request has been sent.  You will recieve an email within 24 hours.</p></div></a>
                </body>
                </html>"; 
